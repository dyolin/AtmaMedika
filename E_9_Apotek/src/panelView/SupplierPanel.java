...
public class SupplierPanel extends javax.swing.JPanel {
    ...
    private SupplierControl sp = new SupplierControl();
    ...
    public void setComponentSupplier(boolean value){
    ...
    public void setSupplierEditDeleteButton(boolean value){
    ...
    public void showTableBySearch(String target){
        tableData.setModel(sp.showTable(target));
    }
    
    public void inputKosong() throws InputKosongException{
        if(namaPelangganField.getText().isEmpty() || nomorTeleponLabelPelanggan.getText().isEmpty() || alamatPelangganArea.getText().isEmpty()){
    ...
    public SupplierPanel() {
        ...
        sp = new SupplierControl();
        
        showTableBySearch("");
        clearText();
        setComponentSupplier(false);
        setSupplierEditDeleteButton(false);
    }
    ...
    private void initComponents() {
        ...
        KaryawanApotekLabel.setText("Pemasok Obat");
        ...
        idPelangganLabel.setText("ID Supplier");
        ...
        namaPelangganLabel.setText("Nama Supplier");
    ...
    private void tableDataMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableDataMouseClicked
        ...
        setSupplierEditDeleteButton(true);
        ...
        alamatPelangganArea.setText(tableModel.getValueAt(clickedRow, 2).toString());
        ...
        try{
           ...
           if(opsi == JOptionPane.NO_OPTION || opsi == JOptionPane.CANCEL_OPTION || opsi == JOptionPane.CLOSED_OPTION){
            ...
            if(action.equalsIgnoreCase("tambah")){
                Supplier su = new Supplier(namaPelangganField.getText(), alamatPelangganArea.getText(), nomorTeleponPelangganField.getText());
                sp.insertDataSupplier(su);
            }else{
                Supplier su = new Supplier(namaPelangganField.getText(), alamatPelangganArea.getText(), nomorTeleponPelangganField.getText());
                sp.updateSupplier(su, Integer.parseInt(idPelangganField.getText()));
                selectedId = -1;    
            }
            ...
            JOptionPane.showMessageDialog(rootPane, "Telepon Harus Berupa Angka");
        }
